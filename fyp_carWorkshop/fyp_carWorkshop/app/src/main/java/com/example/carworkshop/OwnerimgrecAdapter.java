...
public class OwnerimgrecAdapter extends RecyclerView.Adapter<OwnerimgrecAdapter.MyViewHolder> {
    private List<ImagesList> imagesLists;
    Context context;

    public OwnerimgrecAdapter(List<ImagesList> imagesLists, Context context) {
    ...
    public void onBindViewHolder(@NonNull OwnerimgrecAdapter.MyViewHolder holder, final int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                DatabaseReference userReference = FirebaseDatabase.getInstance().getReference("Owners").child(firebaseUser.getUid());
