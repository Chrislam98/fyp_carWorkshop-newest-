...
public class OwnerAppointmentlistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pending.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                reference = FirebaseDatabase.getInstance().getReference("Owner_appointment").child(firebaseUser.getUid()).orderByChild("status").equalTo("pending");
                reference.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        aplist.clear();
        ...
        deny.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                reference = FirebaseDatabase.getInstance().getReference("Owner_appointment").child(firebaseUser.getUid()).orderByChild("status").equalTo("deny");
                reference.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        aplist.clear();
                        if (dataSnapshot.exists()) {
                            ...
                            Toast.makeText(OwnerAppointmentlistActivity.this, "No Deny Appointment", Toast.LENGTH_SHORT).show();
                        }
                    }
                    @Override
                    public void onCancelled(@NonNull DatabaseError databaseError) {
        ...
        complete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                reference = FirebaseDatabase.getInstance().getReference("Owner_appointment").child(firebaseUser.getUid()).orderByChild("status").equalTo("complete");
                reference.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        aplist.clear();
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                reference = FirebaseDatabase.getInstance().getReference("Owner_appointment").child(firebaseUser.getUid()).orderByChild("status").equalTo("cancel");
                reference.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        aplist.clear();
