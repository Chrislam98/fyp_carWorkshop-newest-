...
public class DetailsAppointmentActivity extends AppCompatActivity {
    ...
    TextView ownerId, workshopName, workshopAddress, appointmentNum, ownerName, email, appointmentDate, appointmentTime, carPlateNum, carBrand, status;
    Button goBack;
    ImageView imageUrl;
    ImageButton btnMap, btnMapName;
    RecyclerView ownerServices;
