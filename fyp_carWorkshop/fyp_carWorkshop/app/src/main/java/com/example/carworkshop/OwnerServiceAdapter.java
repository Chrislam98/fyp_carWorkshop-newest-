...
public class OwnerServiceAdapter extends RecyclerView.Adapter <OwnerServiceAdapter.OwnerServiceViewHolder> {
    ...
    public OwnerServiceAdapter(Context c, ArrayList<Owner_service> ownerServiceArrayList) {
        this.c = c;
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    if (isChecked) {
                        ...
                        databaseReference = FirebaseDatabase.getInstance().getReference("Appointment_service")
                                .child(firebaseUser.getUid()).child(currentDate);
                        ...
                        assert firebaseUser != null;
                        databaseReference = FirebaseDatabase.getInstance().getReference("Appointment_service")
                                .child(firebaseUser.getUid()).child(currentDate).child(category1);
