    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ChangeAdminPasswordActivity.this,AdminHomepageActivity.class));
            }
        });
        ...
        changePsw.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(txtOldPsw.isEmpty() || txtNewPsw.isEmpty() || txtConfirmPsw.isEmpty()){
                    Toast.makeText(ChangeAdminPasswordActivity.this,"All fields are required", Toast.LENGTH_SHORT).show();
                }
                else if(txtNewPsw.length() < 6){
                    Toast.makeText(ChangeAdminPasswordActivity.this,"The new password length should be more then 6 character",Toast.LENGTH_SHORT).show();
                }
                else if (! txtConfirmPsw.equals(txtNewPsw)){
                    Toast.makeText(ChangeAdminPasswordActivity.this,"Confirm password is no match will new password",Toast.LENGTH_SHORT).show();
                }
                else{
                    ...
                    firebaseUser.updatePassword(txtNewPsw).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                ...
                                Intent intent = new Intent(ChangeAdminPasswordActivity.this,MainActivity.class);
                                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                                startActivity(intent);
                            }
                            else{
                                Toast.makeText(ChangeAdminPasswordActivity.this, task.getException().getMessage(),Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
