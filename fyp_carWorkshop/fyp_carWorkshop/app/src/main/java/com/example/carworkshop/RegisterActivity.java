...
public class RegisterActivity extends AppCompatActivity {
    private MaterialEditText userName,emailAddress,password,mobile,urole;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String user_role = urole.getText().toString();
                ...
                if(selected_gender == null){
                    ...
                    if(TextUtils.isEmpty(user_name) || TextUtils.isEmpty(user_role) || TextUtils.isEmpty(email) || TextUtils.isEmpty(txt_password) || TextUtils.isEmpty(txt_mobile)){
                        Toast.makeText(RegisterActivity.this,"All fields are required", Toast.LENGTH_SHORT).show();
                    }
                    else{
                        register(user_name,user_role,email,txt_password,txt_mobile,gender);
                    }
                }
            }
        });
    ...
    private void register(final String user_name, final String user_role, final String email, String txt_password, final String txt_mobile, final String gender) {
